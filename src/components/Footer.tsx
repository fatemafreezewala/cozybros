          ...
          <div className='row align-items-center'>
            <div className='col-md-12 col-xl-4'>
              <div className='pbmit-footer-logo'>
                <img className="img-fluid" src='/assets/images/cozy-bros-white-logo.svg' alt='' />
              </div>
            </div>
              ...
              <div className='widget pbmit-two-column-menu'>
                ...
                <div className='textwidget'>
                  <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                    ...
                    <li style={{ marginBottom: '8px' }}>
                      <a href='/about-us' style={{ color: '#ffffff', textDecoration: 'none', fontSize: '14px' }}>About</a>
                    </li>
                    <li style={{ marginBottom: '8px' }}>
                      <a href='/services' style={{ color: '#ffffff', textDecoration: 'none', fontSize: '14px' }}>Services</a>
                    </li>
                    <li style={{ marginBottom: '8px' }}>
