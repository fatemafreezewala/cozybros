                    ...
                    <div className="pbmit-icon-wrapper">
                      ...
                      <h2 className="pbmit-element-title">
                        <a href="tel:+125-8845-5421">
                          <span className="pbmit-button-text">+125-8845-5421</span>
                        </a>
                      </h2>
                    </div>
        ...
        <div className="row">
          ...
          <div className="col-md-3">
            <div className="service-images-wrapper">
              ...
              {/* Bottom Image - Hand with Remote */}
              <div className="service-image">
                <img 
                  src="/assets/images/Home/Remote.svg" 
                  alt="Hand with AC Remote" 
                  className="img-fluid rounded"
                  style={{ maxWidth: '200px' }}
                />
              </div>
            ...
            <div className="services-list px-4">
              ...
              <div className="service-box d-flex align-items-start mb-5">
                <div className="service-icon me-4">
                  <div className="icon-circle bg-light border rounded d-flex align-items-center justify-content-center" 
                       style={{ width: '70px', height: '70px', minWidth: '70px', borderColor: '#e0e0e0' }}>
                    <img src="/assets/images/Home/FurnaceorAcIssue.svg" alt="HVAC" style={{width: '40px', height: '40px'}} />
                  </div>
                </div>
                <div className="service-content">
                  <h4 className="fw-bold mb-3" style={{ color: '#333', fontSize: '24px' }}>Furnace Or AC Issue?</h4>
                  <p className="mb-0" style={{ fontSize: '16px', color: '#666', lineHeight: '1.7' }}>
                    Don't let the big box companies fool you, we can honestly work and troubleshoot right 
                    away 70% of the time without breaking your system.
                  </p>
                </div>
              </div>
              ...
              <div className="service-box d-flex align-items-start mb-5">
                <div className="service-icon me-4">
                  <div className="icon-circle bg-light border rounded d-flex align-items-center justify-content-center" 
                       style={{ width: '70px', height: '70px', minWidth: '70px', borderColor: '#e0e0e0' }}>
                    <img src="/assets/images/Home/FurnaceBoilerACInstallations.svg" alt="HVAC" style={{width: '40px', height: '40px'}} />
                  </div>
                </div>
                <div className="service-content">
                  <h4 className="fw-bold mb-3" style={{ color: '#333', fontSize: '24px' }}>Furnace, Boiler, AC Installations</h4>
                  <p className="mb-0" style={{ fontSize: '16px', color: '#666', lineHeight: '1.7' }}>
                    We install top quality energy efficient units from trusted brands. Not only do we offer 
                    planning for staying cost effective.
                  </p>
                </div>
              </div>
              ...
              <div className="service-box d-flex align-items-start mb-5">
                <div className="service-icon me-4">
                  <div className="icon-circle bg-light border rounded d-flex align-items-center justify-content-center" 
                       style={{ width: '70px', height: '70px', minWidth: '70px', borderColor: '#e0e0e0' }}>
                    <img src="/assets/images/Home/Maintenance.svg" alt="HVAC" style={{width: '40px', height: '40px'}} />
                  </div>
                </div>
                <div className="service-content">
                  <h4 className="fw-bold mb-3" style={{ color: '#333', fontSize: '24px' }}>Maintenance</h4>
                  <p className="mb-0" style={{ fontSize: '16px', color: '#666', lineHeight: '1.7' }}>
                    Keep up your system and get the most out of it. We offer affordable air conditioning 
